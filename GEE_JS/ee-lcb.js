...
function sr_initBandMetadata(img){
  ...
  return img.set({'bands':'original', 'band_names':isL8, 'harmonized_to': 'null'});
}
...
function sr_getLE07img(){
  return sr_initBandMetadata(ee.Image('LANDSAT/LE07/C01/T1_SR/LE07_038029_20050814'))
